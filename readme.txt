...
Our results for new transfer objectives (λ = 0.55, 0.6, and 0.7) can be found in Transfer-Results pdf.
If the PDF does not render in the browser preview, please download the file to view it.
